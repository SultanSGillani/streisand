...
CMDS[shell-api]="docker exec -ti jumpcut_api_1 bash"
CMDS[shell-db]="docker exec -ti jumpcut_postgres_1 bash"
CMDS[shell-frontend]="docker exec -ti jumpcut_frontend_1 bash"
