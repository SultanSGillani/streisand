...
CMDS[shell-nginx]="docker exec -ti nginx bash"
CMDS[shell-db]="docker exec -ti db bash"
CMDS[shell-react]="docker exec -ti react bash"
...
CMDS[log-react]="docker-compose -f docker-compose.production.yml logs react"
