    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('swarm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tracker.Swarm')),
        ...
        migrations.AddField(
            model_name='user',
            name='torrents',
            field=models.ManyToManyField(related_name='users', through='torrent_stats.TorrentStats', to='torrents.Torrent'),
        ),
        migrations.AddField(
            model_name='user',
            name='user_class',
